...
def plot_isocline(ax, func, x_interval, y_interval, x_step=0.5, y_step=0.5, **kwargs):
    ...
    line_factor = 1 / 10
    x_comp = lambda x, y: line_factor * x_len_factor * cos(angle_from_slope(func(x, y)))
    y_comp = lambda x, y: line_factor * x_len_factor * sin(angle_from_slope(func(x, y)))
    u = [
        [
